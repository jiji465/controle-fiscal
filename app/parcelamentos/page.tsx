...
import { CheckCircle2, Clock, DollarSign, AlertTriangle, Search } from "lucide-react"
...
export default function ParcelamentosPage() {
  ...
  const overdueInstallments = installments.filter((i) => isOverdue(i.calculatedDueDate) && i.status !== "paid")
        ...
        <div className="space-y-6">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-4 h-auto">
              ...
              <TabsTrigger value="paid" className="flex flex-col gap-1 py-3">
                <div className="flex items-center gap-1.5">
